...
public:
  ...
  static void print_stats(){
    /*void elina_abstract0_fprint(FILE* stream,
       ...
       elina_abstract0_fprint(NULL, NULL, NULL, NULL);
  }
...
template<typename Number, typename VariableName, elina_domain_id_t ElinaDom>
class stats_domain_traits<elina_domain<Number, VariableName, ElinaDom>> {
public:
  static void print_stats(void) {
    elina_domain<Number, VariableName, ElinaDom>::print_stats();
  }
};
} // namespace domains
} // namespace crab
